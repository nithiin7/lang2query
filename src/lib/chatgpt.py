...
"""
    ...
    def _generate_with_tools(
        ...
        **kwargs
        ...
        """
        Tool-enabled generation using OpenAI's function calling.
        Uses LangChain's bind_tools which internally uses OpenAI's function calling.
        """
        try:
            ...
            logger.info(f"Generating with tool support using OpenAI function calling. Tools: {len(tools) if tools else 0}")
